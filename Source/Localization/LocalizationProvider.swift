...
public class LocalizationProvider {
    ...
    fileprivate var privateTranslations: TranslationTable = [:]
...
fileprivate extension LocalizationProvider {
    ...
    func mergeLanguage(identifier: String, langPathDict: LangPathDict, table: inout TranslationTable) -> Bool {
    ...
    func loadAllStringTables(tables: [StringTable], defaultLanguage: String) -> [LangPathDict] {
        var allTables = [LangPathDict]()
        tables.forEach { (table) in
            let stringTables = scanForAllLocalizedFiles(table: table, defaultLanguage: defaultLanguage)
    ...
    /// The method looks for all localization files belonging to given StringTable.
    ...
    func scanForAllLocalizedFiles(table: StringTable, defaultLanguage: String) -> LangPathDict {
