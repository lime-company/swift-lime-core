...
/// The StringTable describes one localized string table (for any language) stored in
/// one specific bundle.
public class StringTable {
    ...
    public static func defaultTable() -> StringTable {
        return StringTable("Localizable")
    }
}
